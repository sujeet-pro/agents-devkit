...
Generate precise, professionally-styled diagrams as `.drawio` XML files. This stage writes a `.drawio` source file only -- use `diagramkit render` to produce images.
