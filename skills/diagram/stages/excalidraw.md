...
Generate architecture diagrams, system overviews, and freeform diagrams as `.excalidraw` JSON files. This stage writes a `.excalidraw` source file only -- use `diagramkit render` to produce images.
