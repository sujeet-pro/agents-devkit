...
Run `zsh scripts/check-skill-deps.zsh <skill> ...context...` before source-side work so the correct MCP is validated from the real input, not from a hard-coded global list.
