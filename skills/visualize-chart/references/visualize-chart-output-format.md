...
Chart image path + the takeaway sentence + data-source citation.
...
Add: alternative chart types considered, data-cleaning steps, statistical caveats (sample size, missing data, outliers).
