...
| Report written | `.temp/reports/build-feature-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/build-feature-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
