...
| Report written | `.temp/reports/plan-brainstorm-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/plan-brainstorm-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
