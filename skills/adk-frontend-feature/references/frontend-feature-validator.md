...
| Report written | `.temp/reports/frontend-feature-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/frontend-feature-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
