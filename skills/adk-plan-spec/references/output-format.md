...
Spec markdown using the doc-type template + a one-paragraph TL;DR at the top.
...
Add: comparison table vs alternatives, sequence/state diagrams for non-trivial flows, error matrix, rollout plan, success metrics.
