...
### Question 1
**Q:** What is the source and target (framework, version, runtime)?

**How to pick:** Be specific: 'React 17 → React 19', 'Node 18 → Node 22', 'Webpack → Vite'. Vague targets cause vague plans.

### Question 2
**Q:** Is downtime acceptable, or does the system stay live throughout?

**How to pick:** Downtime allowed → simpler cutover. Live → compatibility shims + dual-write/dual-read for stateful systems.

### Question 3
**Q:** Are there codemods or migration tools published by the upstream?

**How to pick:** Yes → use them; treat as one step. No → write a migration script committed to the repo.
