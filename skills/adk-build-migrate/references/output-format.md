...
Step-by-step plan + per-step rollback + current step status + remaining steps + risk notes.
...
Add: compatibility-shim inventory with removal deadlines, deprecated-API call sites, performance delta per step, traffic-shift plan if applicable.
