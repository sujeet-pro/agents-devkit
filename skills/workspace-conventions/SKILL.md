...
All skills must invoke `/adk:workspace-conventions` (or use the inline fallback in their Shared Skills table) to determine output paths before creating files.
