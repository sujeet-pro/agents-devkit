...
- SSR / Next.js / Remix work -> different routing, data, and deploy concerns. Use `@adk:frontend-feature` (a.k.a. `adk-frontend-feature`) (or `@adk:build-feature` (a.k.a. `adk-build-feature`)) on the SSR stack.
