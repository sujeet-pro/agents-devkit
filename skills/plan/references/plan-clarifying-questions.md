...
### Question 1
**Q:** What's missing right now: a decision, a fact, a written spec, an architecture, or an ordered plan?

**How to pick:** Decision → brainstorm. Fact → research. Spec → spec. Architecture → design. Ordered plan → roadmap.

### Question 2
**Q:** Is the direction already locked?

**How to pick:** Yes → skip brainstorm; go to spec/design/roadmap. No → brainstorm.
