...
Gap audit table (decision/fact/spec/design/plan) showing which are present and which are missing.

## Status banner

Lead the report with one of:
`ROUTED <plan-task>  |  ALREADY-PLANNED-SKIP`
