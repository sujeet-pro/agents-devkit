...
The plan is not executable until the user approves it. For Medium and Large tasks, present the finished plan through the inline plan approval protocol before offering execution.

Assume they are a skilled developer, but know almost nothing about our toolset or problem domain. Assume they don't know good test design very well.

**Announce at start:** "I'm using the plan skill (write mode) to create the implementation plan."
...
**2. Inline Execution** - Execute tasks in this session using execute mode, batch execution with checkpoints
