...
| Report written | `.temp/reports/plan-design-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/plan-design-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
