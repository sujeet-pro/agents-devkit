...
Design markdown with one mermaid diagram, alternatives table, failure modes, rollout.
...
Add: component-level interface signatures, sequence diagram per primary flow, capacity/cost calculations, security threat model, observability plan.
