...
| Report written | `.temp/reports/review-local-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/review-local-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
