...
Comment-by-comment table (id / severity / status / fix commit / reply preview).
...
Add: per-comment plan before fix, evidence each fix actually addresses the issue, residual disagreement notes.
