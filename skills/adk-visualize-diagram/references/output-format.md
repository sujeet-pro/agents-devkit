...
Path to source file + path to rendered light/dark SVGs + the markdown snippet to embed.
...
Add: alt text suggestions, complexity check (node/edge count), recommended further diagrams to break things up.
