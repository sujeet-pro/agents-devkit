...
- **Google Docs**: do **not** attempt to post comments via MCP (unreliable). Instead, produce a markdown file at `.temp/adk-docs-review/<doc-title>-comments.md` listing each comment with its target section/paragraph and content. Present the file path and ask the user to add comments manually.
