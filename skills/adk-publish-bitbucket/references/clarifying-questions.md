...
### Question 1
**Q:** Action: pr-create / pr-update / pr-comment / pr-task / pr-merge / issue-create / issue-comment?

**How to pick:** Comments are discussion; tasks are blocking checklist items the author must resolve. Pick deliberately.

### Question 2
**Q:** Target: PR/issue ID or URL?

**How to pick:** Required for actions on existing artifacts.

### Question 3
**Q:** Body source: file path or auto-generate?

**How to pick:** Prefer file (drafted upstream). Auto-generate only when no body exists.
