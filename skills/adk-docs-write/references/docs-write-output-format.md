...
Final doc markdown + 3-bullet TL;DR + validation results (commands run, links checked).
...
Add: outline before the draft, source-evidence per section (file:line), drift-from-code log if refreshing, follow-up TODOs by section.
