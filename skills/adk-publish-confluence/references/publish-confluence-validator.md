...
| Report written | `.temp/reports/publish-confluence-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/publish-confluence-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
