...
One line: chosen category + task skill, plus a one-sentence why.
...
Lifecycle table, evidence for the routing choice, and the recommended chain (e.g. plan → roadmap → build).
