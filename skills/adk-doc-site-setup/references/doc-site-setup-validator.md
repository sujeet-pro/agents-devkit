...
| Report written | `.temp/reports/doc-site-setup-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/doc-site-setup-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
