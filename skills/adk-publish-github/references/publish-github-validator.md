...
| Report written | `.temp/reports/publish-github-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/publish-github-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
