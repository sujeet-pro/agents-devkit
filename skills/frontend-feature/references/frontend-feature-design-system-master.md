...
The pre-delivery checklist (`<task>-pre-delivery-checklist.md`) and the validator (`frontend-feature-validator.md`) both reference this file. A page that does not match its `pages/<page>.md` (or MASTER if no override) is a Phase 3 BLOCKER.
