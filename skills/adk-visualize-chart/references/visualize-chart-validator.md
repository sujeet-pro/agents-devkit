...
| Report written | `.temp/reports/visualize-chart-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/visualize-chart-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
