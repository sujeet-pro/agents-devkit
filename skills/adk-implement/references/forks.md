...
Each fork is a decision point the skill logs to `~/.config/adk/learning/decisions.jsonl`. `/adk-improve` reads these to propose defaults for `~/.config/adk/overrides.yaml.defaults.adk-implement.<fork_id>`.
