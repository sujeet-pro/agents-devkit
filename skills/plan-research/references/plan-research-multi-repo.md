...
`adk-plan-research` can pull context from one or more additional repositories beyond the host repo. This is useful when the deliverable describes a system that spans multiple repos (cross-repo migration, integration docs, multi-service onboarding, audit of a meta-project).
