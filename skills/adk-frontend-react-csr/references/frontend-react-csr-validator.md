...
| Report written | `.temp/reports/frontend-react-csr-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/frontend-react-csr-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
