...
Message draft (subject + body) + detected convention + breaking-change note.
...
Add: diff summary, recent-commit examples used to infer style, alternative subject lines, suggested labels.
