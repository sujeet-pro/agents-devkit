...
- Behavior changes -> `@adk:build-feature` (a.k.a. `adk-build-feature`)
- Framework / runtime / library version migration -> `@adk:build-migrate` (a.k.a. `adk-build-migrate`)
- Only tests change -> `@adk:build-test` (a.k.a. `adk-build-test`)
- Dependency cleanup only -> `@adk:build-deps` (a.k.a. `adk-build-deps`)
- UI / frontend restructure -> `@adk:frontend-feature` (a.k.a. `adk-frontend-feature`)
