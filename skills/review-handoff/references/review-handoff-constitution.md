# Constitution for `adk-review-handoff`
...
- Working artifacts (plans, drafts, reports, cloned repos) go under `.temp/` — see `references/review-handoff-artifact-format.md` for the path matrix.
...
## Skill-specific non-negotiables (`adk-review-handoff`)
...
## Communication rules
- Lead with the status banner from `references/review-handoff-persona.md`: `HANDOFF-WRITTEN  |  HANDOFF-WITH-RISKS`.
