...
### Question 1
**Q:** Action: pr-create / pr-update / pr-comment / pr-merge / pr-request-review / issue-create / issue-comment / label / status?

**How to pick:** Pick by destination + intent. pr-merge is special — always requires explicit gate even with --auto.

### Question 2
**Q:** Target: PR/issue number or URL?

**How to pick:** Required for actions that operate on an existing artifact.

### Question 3
**Q:** Body source: file path, inline draft, or auto-generate via adk-publish-commit?

**How to pick:** Prefer file path (drafted upstream). Auto-generate only when no body exists.
