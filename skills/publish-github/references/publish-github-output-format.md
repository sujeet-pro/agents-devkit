...
Action result URL + verification block (title/body/labels match expected) + tool used (gh / MCP).
...
Add: full command line, full read-back JSON, follow-up suggestions (request reviewers, link to release draft).
