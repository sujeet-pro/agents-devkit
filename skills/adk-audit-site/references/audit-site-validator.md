...
| Report written | `.temp/reports/audit-site-<slug>.md` (or this skill's analogue) exists with full content | File path + size |
| Validator log written | `.temp/notes/audit-site-<slug>-validator.md` exists with all four phases' outcomes | File path + size |
