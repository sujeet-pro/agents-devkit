...
Invoke the `coding` skill to detect repo frameworks and load matching coding guidelines. Pass the list of changed files from the diff for scoped detection.
