# Constitution for `adk-review-pr`
...
## Skill-specific non-negotiables (`adk-review-pr`)
...
## Communication rules
- Lead with the status banner from `references/persona.md`: `REVIEW-DRAFT (dry-run)  |  REVIEW-POSTED <n> inline + summary  |  AWAITING-APPROVAL-TO-POST`.
