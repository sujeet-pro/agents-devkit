...
Answer first (≤3 bullets), then evidence list with citations, then confidence label, then open questions.
...
Add: source-by-source notes table, ruled-out alternatives with one-line reason, freshness score per source, decision implications.
