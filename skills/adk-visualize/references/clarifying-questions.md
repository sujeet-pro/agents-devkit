...
### Question 1
**Q:** Is the goal a structural diagram (boxes + arrows showing relationships) or a data chart (numeric values plotted)?

**How to pick:** Diagram → adk-visualize-diagram. Chart → adk-visualize-chart.
