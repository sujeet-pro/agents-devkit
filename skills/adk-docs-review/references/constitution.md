# Constitution for `adk-docs-review`
...
## Skill-specific non-negotiables (`adk-docs-review`)
...
## Communication rules
- Lead with the status banner from `references/persona.md`: `DOC-REVIEW-DRAFT  |  DOC-FRESH (no Blockers)  |  DOC-DRIFTED <n> findings`.
