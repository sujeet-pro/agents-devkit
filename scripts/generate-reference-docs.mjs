...
- **PreToolUse:Bash** — blocks force-push, hard-reset on protected branches, \`rm -rf $HOME\`, unrequested PR merges, writes to \`$ADK_MEMORY_HOME/learning/archive/\`, \`--no-verify\` bypasses.
