...
argument-hint: <input-url-or-description> [-i | --interactive] [--scope vertical-slice|full|spike] [--plan|--act] [--no-push] [--detailed] [--deep]
---

Invoke the adk-implement skill at {{ADK_REPO}}/skills/adk-implement/SKILL.md.

@{{ADK_REPO}}/AGENTS.md
@{{ADK_REPO}}/skills/adk-implement/SKILL.md
