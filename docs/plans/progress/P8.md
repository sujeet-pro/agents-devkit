# P8 · TUI — α + β + γ + δ + θ + ζ + η + ε + κ + ι slices (2026-05-21 → 2026-05-22)

Status: **SHIPPED locally** (read-only viewer + run-sync + single-PR review + worker visibility + multi-select batch + add-PR + repo management + phase-aware progress + agent picker + end-of-run recap). Sub-phase λ pending.
