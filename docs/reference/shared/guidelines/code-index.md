---
title: 'guidelines/code-index'
description: '`scripts/lib/code_index/` is the shared code-index library. It''s the'
source: 'shared/guidelines/code-index.md'
group: 'shared-guidelines'
order: 6302
---
# shared/guidelines/code-index
