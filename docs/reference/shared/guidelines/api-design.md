---
title: 'guidelines/api-design'
description: '- **REST/HTTPS JSON**: public APIs, cross-team, browser-first. Default unless reason to deviate.'
source: 'shared/guidelines/api-design.md'
group: 'shared-guidelines'
order: 6301
---
# shared/guidelines/api-design
