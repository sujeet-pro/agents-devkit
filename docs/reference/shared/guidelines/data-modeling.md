---
title: 'guidelines/data-modeling'
description: '1. **Migrations are forward-only** with a documented rollback. No "down migration" that destroys data.'
source: 'shared/guidelines/data-modeling.md'
group: 'shared-guidelines'
order: 6303
---
# shared/guidelines/data-modeling
