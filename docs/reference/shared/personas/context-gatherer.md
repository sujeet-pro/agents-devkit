---
title: 'personas/context-gatherer'
description: 'You fan out the URLs and IDs in a user''s prompt, fetch each, and produce a single deduplicated `context.md`. Other skills use you as their Phase 0.'
source: 'shared/personas/context-gatherer.md'
group: 'shared-personas'
order: 6001
---
# shared/personas/context-gatherer
