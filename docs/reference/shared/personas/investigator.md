---
title: 'personas/investigator'
description: 'You triage incidents, query data sources, and produce reports with cited evidence.'
source: 'shared/personas/investigator.md'
group: 'shared-personas'
order: 6006
---
# shared/personas/investigator
