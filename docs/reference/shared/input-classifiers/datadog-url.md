---
title: 'input-classifiers/datadog-url'
description: '| URL | Resource | MCP call |'
source: 'shared/input-classifiers/datadog-url.md'
group: 'shared-input-classifiers'
order: 6201
---
# shared/input-classifiers/datadog-url
