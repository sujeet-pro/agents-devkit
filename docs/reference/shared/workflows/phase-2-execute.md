---
title: 'workflows/phase-2-execute'
description: '1. **Load the approach-specific reference**: `skills/<skill-name>/references/<approach>.md`.'
source: 'shared/workflows/phase-2-execute.md'
group: 'shared-workflows'
order: 6102
---
# shared/workflows/phase-2-execute
