---
title: 'workflows/phase-3-validate'
description: '1. **Repo-native validators**: detect from `package.json`, `pyproject.toml`, `go.mod`, `Cargo.toml`, etc.'
source: 'shared/workflows/phase-3-validate.md'
group: 'shared-workflows'
order: 6103
---
# shared/workflows/phase-3-validate
