---
title: 'workflows/phase-1-advise'
description: '1. **Summarize the context** in 3–5 bullets (drawn from `task-slug/context.md`).'
source: 'shared/workflows/phase-1-advise.md'
group: 'shared-workflows'
order: 6101
---
# shared/workflows/phase-1-advise
...
- Read `$ADK_DATA_HOME/improve/learning/decisions.jsonl` + `summary.md` for prior matching `fork_id`s.
- Read `$ADK_CONFIG_HOME/core.yaml.defaults.<skill>.*`.
