...
- Reviewing the code itself -> `@adk:review-local` (a.k.a. `adk-review-local`)
- Pushing the commit / opening the PR on a remote -> `@adk:publish-github` (a.k.a. `adk-publish-github`) / `@adk:publish-bitbucket` (a.k.a. `adk-publish-bitbucket`)
- Authoring project documentation -> `@adk:docs-write` (a.k.a. `adk-docs-write`)
- Planning implementation work -> `@adk:plan-roadmap` (a.k.a. `adk-plan-roadmap`)
