...
- Numeric / categorical data plot -> `@adk:visualize-chart` (a.k.a. `adk-visualize-chart`)
- UI mockup or component design -> `@adk:frontend-design` (a.k.a. `adk-frontend-design`)
- Architecture write-up (text + one diagram) -> `@adk:plan-design` (a.k.a. `adk-plan-design`), which can call this skill for the diagram
