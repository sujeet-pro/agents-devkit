...
- Pure fact-finding with no decision -> `@adk:plan-research` (a.k.a. `adk-plan-research`)
- Direction is already locked, just write the artifact -> `@adk:plan-spec` (a.k.a. `adk-plan-spec`) / `@adk:plan-design` (a.k.a. `adk-plan-design`) / `@adk:plan-roadmap` (a.k.a. `adk-plan-roadmap`)
- Implementation -> `@adk:build-feature` (a.k.a. `adk-build-feature`)
...
7. **Recommend route** - name the next skill (`adk-plan-spec`, `adk-plan-design`, `adk-plan-roadmap`, `adk-build-feature`, `@adk:build-refactor` (a.k.a. `adk-build-refactor`), `@adk:build-migrate` (a.k.a. `adk-build-migrate`), `@adk:frontend-design` (a.k.a. `adk-frontend-design`), `@adk:docs-write` (a.k.a. `adk-docs-write`)).
