---
title: 'adk-investigate:incident-investigator'
...
source: 'plugins/adk-investigate/agents/incident-investigator.md'
group: 'investigate-agents'
order: 4201
---
# adk-investigate:incident-investigator

## Source

`plugins/adk-investigate/agents/incident-investigator.md`
