---
title: 'adk-agent-code-reviewer'
description: 'Adk''s code reviewer subagent. Findings-first, severity-tiered, evidence-quoted. Used by adk-review, adk-implement (self-review phase), adk-investigate (when code is implicated). Reads diffs and surrounding files;...'
agent: 'adk-agent-code-reviewer'
source: 'agents-claude/agents/adk-agent-code-reviewer.md'
group: 'agents'
order: 2000
---
# adk-agent-code-reviewer

Adk's code reviewer subagent. Findings-first, severity-tiered, evidence-quoted. Used by adk-review, adk-implement (self-review phase), adk-investigate (when code is implicated). Reads diffs and surrounding files; never edits, posts, or merges. Loads the full shared/personas/code-reviewer.md persona.

## Source

`agents-claude/agents/adk-agent-code-reviewer.md`
