---
title: 'adk-pr-reviews'
description: 'Batch driver over /adk-pr-review with optional slack scanning + reactions + reminders. Reads a JSON5 queue at `~/.agents-devkit/pr-reviews/queue.json5`; per-row entry has `pr_link` (required) + optional `slack` info...'
skill: 'adk-pr-reviews'
source: 'skills/adk-pr-reviews/SKILL.md'
group: 'skills'
order: 1006
---
# adk-pr-reviews
...
`skills/adk-pr-reviews/SKILL.md`
...
new_status = "needs_fix" if n_findings > 0 else "reviewed"
slack-react with new_status emoji (remove previous)
update queue entry + state.json
```

## Slack reactions

The slack config maps status → emoji (or `null` to suppress). On status transitions, the script:

1. Removes the previously-reacted emoji (tracked in `slack.last_reaction_status` per entry).
...
- `references/queue-format.md` — see [`/adk-pr-reviews/references/queue-format.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-pr-reviews/references/queue-format.md)
- `references/rules.md` — see [`/adk-pr-reviews/references/rules.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-pr-reviews/references/rules.md)
- `references/slack-config.md` — see [`/adk-pr-reviews/references/slack-config.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-pr-reviews/references/slack-config.md)
- `references/workflow.md` — see [`/adk-pr-reviews/references/workflow.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-pr-reviews/references/workflow.md)
