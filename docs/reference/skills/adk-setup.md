---
title: 'adk-setup'
description: 'Set-up, configure-overrides, init-config, refresh-metadata, verify-mcps, check-env. Stewards `~/.config/adk/overrides.yaml` and the metadata cache. NOT a CLI-dep installer — brew, gh, jq, uv, node are the user''s job...'
skill: 'adk-setup'
