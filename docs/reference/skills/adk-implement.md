---
title: 'adk-implement'
description: 'Implement, build, add, write, ship, code-up, wire-up code in an existing repo. Triggers on: Jira URL or KEY-NUM (specialized from-jira sub-flow — the most common path), GitHub issue URL or #N (from-issue), Confluence...'
skill: 'adk-implement'
...
- `references/dispatch.md` — see [`/adk-implement/references/dispatch.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-implement/references/dispatch.md)
- `references/forks.md` — see [`/adk-implement/references/forks.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-implement/references/forks.md)
- `references/rules.md` — see [`/adk-implement/references/rules.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-implement/references/rules.md)
- `references/workflow.md` — see [`/adk-implement/references/workflow.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-implement/references/workflow.md)
