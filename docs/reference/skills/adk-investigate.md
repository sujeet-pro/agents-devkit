...
description: 'Investigate, debug, why-is-X-slow/broken/down, what-changed, RCA, root-cause, post-mortem. Multi-source data investigator. Read-only. Triggers on: symptom + service ("checkout broken", "users see 500s" — incident...'
...
`skills/adk-investigate/SKILL.md`
...
- `references/dispatch.md` — see [`/adk-investigate/references/dispatch.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-investigate/references/dispatch.md)
- `references/forks.md` — see [`/adk-investigate/references/forks.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-investigate/references/forks.md)
- `references/rules.md` — see [`/adk-investigate/references/rules.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-investigate/references/rules.md)
- `references/workflow.md` — see [`/adk-investigate/references/workflow.md`](https://github.com/sujeet-pro/agents-devkit/blob/main/skills/adk-investigate/references/workflow.md)
