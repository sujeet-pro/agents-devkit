---
title: 'adk-improve'
description: 'Improve, learn, refresh-metadata, update-defaults, self-improve, train-skill, learn-from-session. The self-improvement loop. Always interactive (asks first: improve skill defaults from decision logs, metadata via MCP...'
skill: 'adk-improve'
source: 'skills/adk-improve/SKILL.md'
group: 'skills'
order: 1003
---
# adk-improve
