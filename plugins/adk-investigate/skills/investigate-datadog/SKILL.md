...
metadata:
  ...
  needs_mcp: [datadog]
  needs_meta_info: [info, repos, datadog]
argument-hint: "<question> [--use <investigate|dashboard-summary|alert-triage>] [--time <window>] [--env <env>] [-i]"
---
